...
function codexHome(env) { return resolve(env.CODEX_HOME ?? join(homedir(), '.codex')); }
function pluginCacheRoot(env) { return join(codexHome(env), 'plugins', 'cache'); }
function runningPluginRoot(env) {
...
export function enabledPluginDataDir(env = process.env) {
